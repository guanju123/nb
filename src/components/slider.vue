<template>
  ...
  <swipe class="my-swipe" :speed="100" :auto="1000">
    <swipe-item class="slide1"><img src="../assets/pic/banner0.jpg" /></swipe-item>
    <swipe-item class="slide2"><img src="../assets/pic/banner1.png" /></swipe-item>
    <swipe-item class="slide3"><img src="../assets/pic/banner0.jpg" /></swipe-item>
  </swipe>
</template>
<script  scoped>
